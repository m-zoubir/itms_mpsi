    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_deposant', models.CharField(choices=[('Etudiant', 'Étudiant'), ('Ensiegnant', 'Enseignant'), ('Employer', 'Employé')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('demande', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='interventions', to='base.demande')),
